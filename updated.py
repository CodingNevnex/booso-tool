import os ;os.system('pip install cryptography');os.system('pip install requests');import requests;from optparse import Option
import requests
import threading
import random
import time
...
ctypes.windll.kernel32.SetConsoleTitleW("NEVNEX Panel || STATUS: Online ")
...
{b}                           NΞVNΞX - - - - - - - - - - - - - - Discord Boost Tool - - - - - - - - - - - - - - NΞVNΞX
                                       ...
                                       $$ |\$$$ |$$ |        \$$$  /  $$ |\$$$ |$$ |      $$  /\$$\ 
                                       $$ | \$$ |$$$$$$$$\    \$  /   $$ | \$$ |$$$$$$$$\ $$ /  $$ |
                                       \__|  \__|\________|    \_/    \__|  \__|\________|\__|  \__|
